...
export default function Home() {
  ...
  const { isMobile, isTablet, heightHeader, isSafari, isMedium, isLG } = useMediaQueryResponsive();
  useEffect(
    () => () => {
  ...
  return (
    <div data-testid="landingPage" className="overflow-hidden landingPage">
      <div className={`lg:bg-landing-lg xl:bg-bg-landing-xl xxl:bg-bg-landing-xxl md:bg-landing-md sm:bg-landing-sm smd:bg-landing-smd bg-landing-xs bg-no-repeat  -z-30 bg-cover xs:bg-bottom sm:bg-bottom md:bg-bottom lg:bg-center xl:bg-center xs:h-[419px] sm:h-[484px] smdd:h-[460px] smd:h-[484px]  md:h-[401px] lg:h-[596px] xl:h-[668px] xxl:bg-center xxl:h-[618px] bgImageLanding`}>
        ...
        <div className={titleClasses}>
          <div className="md:flex md:flex-col ">
            <p className="text-white xs:text-[22px] sm:text-[22px] leading-[30px]  xs:ml-5 sm:ml-5 xs:mb-[3px] sm:mb-1 font-poppinsExtraLight md:text-primario-900">
              Bienvenido a
              <figure itemProp="logo" className="mt-3 md:mt-1 m-0 p-0 w-full sm:pr-[3px] xs:pr-[0px] md:pr-0 smdd:pr-5 xmd:pr-20">
      ...
      {/* steps  */}
      <div className="bg-white flex justify-between xl:w-[1047px] xl:m-auto">
        <div className='lg:ml-[36px] md:ml-[81px] m-auto md:m-0 xl:ml-1'>
          <Typography variant="h2" className="md:text-left text-center lg:mt-[149px] xl:mt-[148px] md:mt-[93px] mt-[80px]  font-poppinsBold ml-5 md:ml-0">
        ...
        <div className='relative md:flex items-center justify-center lg:h-[585px] lg:w-[474px] xl:w-[487px] md:w-[381px] md:h-[471px] hidden md:mt-[62px] lg:mt-[64px] xl:mt-[63px] '>
