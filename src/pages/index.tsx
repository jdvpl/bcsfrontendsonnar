...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="xs:mt-[17rem] sm:mt-[15rem] md:mt-5 bg-gris-90 pb-10">
        <div className="container">
          <Typography variant="h2" className="text-center sm:py-[3rem] xs:py-[3rem]">
            Requisitos
          </Typography>
          <div className="md:grid md:grid-cols-9 gap-3 md:w-10/12 lg:w-4/5 container place-items-center ">
        ...
        <div className="grid sm:grid-cols-2 xs:grid-cols-2 md:grid-cols-4 gap-4">
          <div>
            ...
            <div className="flex justify-center ">
              {/* number */}
              <div className="flex justify-center mt-4 relative w-[88px]">
            ...
            <Typography variant="bodyS3" className="mt-3 text-complementario-100 text-center flex justify-center m-auto flex-col sm:w-[85px] xs:w-[85px]">
          ...
          <div>
            ...
            <Typography variant="bodyS3" className="mt-3 text-complementario-100 text-center flex justify-center m-auto flex-col sm:w-[92px] xs:w-[92px]">
          ...
          <div>
            ...
            <Typography variant="bodyM4" className="text-complementario-100 text-center flex justify-center flex-col">
              Obtenga la <span className="block">
                aprobación
              </span>
            </Typography>
          </div>
      ...
      {/* beneficios */}
      <div className=''>
        <Typography variant="h2" className='mt-20 text-center'>Beneficios</Typography>
        <div className="bg-gris-80 md:grid md:grid-cols-2 sm:grid sm:grid-col-1 xs:mt-[12rem] md:mt-[5rem] relative md:h-[412px] gap-10">
          ...
          <div className="listInitial lg:w-[378px] relative block mx-5 top-[-140px] md:top-0 ">
            <ul>
              <li className="text-[20px] font-light leading-[22px] mt-12">Aprobación inmediata en línea</li>
              <li className="text-[20px] font-light leading-[22px] mt-8">Extensión del subsidio FRECH durante toda la vigencia del crédito</li>
              <li className="text-[20px] font-light leading-[22px] mt-8">Sin documentación física</li>
              <li className="text-[20px] font-light leading-[22px] mt-8">Para clientes y no clientes</li>
              <li className="text-[20px] font-light leading-[22px] mt-8 ">Abonos extraordinarios a capital para reducir el plazo o el valor de la cuota</li>
            </ul>
          </div>
        </div>
      </div>
      {/* questions */}
      <div className="mx-3 md:mx-[92px]">
