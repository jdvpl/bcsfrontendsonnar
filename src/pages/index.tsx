...
export default function Home() {
  ...
  return (
    <div data-testid="landingPage" className="overflow-hidden landingPage">
      ...
      <div className={`lg:bg-[url('../public/images/backgroundLg.svg')] xl:bg-[url('../public/images/backgroundLg.svg')] xxl:bg-[url('../public/images/backgroundLg.svg')] md:bg-[url('../public/images/backgroundMd.svg')] sm:bg-[url('../public/images/backgroundSm.svg')] bg-[url('../public/images/backgroundSm.svg')] bg-no-repeat  -z-30 bg-cover xs:bg-bottom sm:bg-bottom md:bg-bottom lg:bg-center xl:bg-bottom xs:h-[540px] sm:h-[610px] md:h-[750px] lg:h-[755px] xl:h-[715px] xxl:bg-top xxl:h-[910px] bgImageLanding`}>
        <div
      ...
      <div className="xs:mt-[20rem] sm:mt-[20rem] md:mt-[0px] lg:mt-[42px] bg-gris-90 pb-10 ">
        <div className="lg:w-[920px]  md:w-[660px] sm:w-[360px]  m-auto mb-5">
          <Typography
            variant="h2"
          ...
          <div className="flex sm:flex-col md:flex-row lg:flex-row   lg:mb-3  justify-between ">
            <div className="lg:w-[437px] md:w-[325px] ">
              <SelectiveCard
            ...
            <div className="mt-[10px] md:h-[46px] bg-[#B0C2CD;] md:w-[1px] md:pb-4 " />
            <div className="lg:w-[437px] md:w-[325px]">
              <SelectiveCard
          ...
          <div className="flex sm:flex-col md:flex-row lg:flex-row lg:mb-3 justify-between ">
            ...
            <div className="md:h-[46px] mt-[10px] bg-complementario-70 md:w-[1px]  " />
            <div className="lg:w-[437px] md:w-[325px]">
              <SelectiveCard
      ...
      <div className="bg-white relative">
        ...
        <div className="lg:flex">
          ...
          sm:grid-cols-2 xs:grid-cols-2 md:grid-cols-4 gap-3 sm:w-[90%] m-auto lg:justify-items-end lg:w-[460px] md:w-[620px] 
          '>
