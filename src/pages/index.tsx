...
import { ApplicationLoader } from '../components/ui/Loaders/HomeLoader';
  ...
  return (
    <>
      ...
      <main data-testid="landingPage" className="overflow-hidden landingPage">
        ...
        >
          ...
          >
            <div className="md:flex md:flex-col">
              ...
              >
                Aquí le ayudaremos a lograr sus sueños, sin hacer largas filas, ni
                papeleos extensos.
              </Typography>
            </div>
          </section>
        ...
        {/* beneficios */}
        <section
          className="md:mt-[100px] mt-[80px] lg:mt-20"
          role="tabpanel"
          tabIndex={0}
        >
          <Typography
