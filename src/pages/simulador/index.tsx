    ...
    <div>
      ...
      <div className="lg:w-[684px] md:w-[584px] w-[343px] m-auto">
        ...
        <div className="flex gap-3 my-5">
          <button type="button" className={simulatioTypeOption === 'house' ? `w-full max-w-[23.438rem] rounded h-[3rem] transition-all duration-500 text-white bg-primario-100 hover:bg-primario-400 focus:bg-primario-400 focus:text-primario-60 focus:shadow-none shadow-none` : `w-full max-w-[23.438rem] rounded h-[3rem] text-complementario-70 bg-gris-90 shadow-none`} onClick={() => setsimulatioTypeOption('house')}>Valor de vivienda</button>
          <button type="button" className={simulatioTypeOption === 'salary' ? `w-full max-w-[23.438rem] rounded h-[3rem] transition-all duration-500 text-white bg-primario-100 hover:bg-primario-400 focus:bg-primario-400 focus:text-primario-60 focus:shadow-none shadow-none` : `w-full max-w-[23.438rem] rounded h-[3rem] text-complementario-70 bg-gris-90 shadow-none`} onClick={() => setsimulatioTypeOption('salary')}>Cuota que puedo pagar</button>
        </div>
        {
