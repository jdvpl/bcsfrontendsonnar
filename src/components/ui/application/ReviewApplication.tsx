  ...
  return (
    <div className="flex flex-col items-center ">
      ...
      <Card
        ...
        tooltiptext=""
        description
        descriptionHtml={<div className="pl-[27px]">
          <div className="flex">
            <Typography variant='caption1' componentHTML='b' typeFont='Bold' className="  mr-1">MV:</Typography>
            <Typography componentHTML='p' variant='caption1' typeFont='Light' className="">Tasa nominal mes vencido</Typography>
          </div>
          <div className="flex">
            <Typography variant='caption1' componentHTML='b' typeFont='Bold' className="  mr-1">EA:</Typography>
            <Typography componentHTML='p' variant='caption1' typeFont='Light'>Tasa efectiva anual</Typography>
          </div>
        </div>} typeFontProps={{ ...typeFontsPropsNormal, ...{ typeFontTypograhyTitle: 'Light' } }} />
      <Card
        ...
        tooltiptext="" typeFontProps={typeFontsPropsNormal} />
      {lifeInsurance ? (
        <Card
