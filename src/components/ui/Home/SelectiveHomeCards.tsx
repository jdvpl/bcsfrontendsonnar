  ...
  return (
    <section className="container cntainerCards mx-auto lg:w-[1024px] xl:w-[1020px] xxl:w-[930px]  md:grid md:grid-cols-3 grid grid-cols-3 md:mt-[3rem] gap-2 lg:mt-[10rem] xxl:mt-[12rem] md:w-[700px] sm:mt-[65px] mt-[45px] xmd:mt-10 xs:w-[295px] sm:w-[340px] smd:w-[382px] xl:mt-[150px] xs:mt-[30px]">
      ...
      <SelectiveCard
        ...
        titleClasses="xs:mt-[10px] sm:pb-2 xs:text-[10px] md:text-[13px] lg:text-[14px] text-[12px] text-center font-montserratMedium font-semibold text-white w-full leading-[14px] smd:pb-9 md:pb-0 xs:w-full sm:text-[12px]"
        classNamesDescription="font-montserratRegular md:w-[166px] lg:w-[224px] md:text-[12px] lg:text-[16px]  font-monserratLight lg:pb-5 md:pb-1 lg:pb-2 md:block hidden lg:text-[16px]"
        onclick
