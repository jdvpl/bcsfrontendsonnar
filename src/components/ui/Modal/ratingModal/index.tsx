...
export function RatingModal() {
  ...
  return (
    <div
      id="modal"
      className={`bg-black/70 z-50 w-screen h-screen fixed top-0 flex justify-center content-center ${isOpen && 'overflow-y-auto'
        }`}
    >
      <div
      ...
      >
        <div onClick={onOpenModal} className="cursor-pointer text-end">
          <Icons icon="bcs-icon-23" size="text-primario-500 text-end font-bold" data-testid="iconRating" />
        </div>
        <RateForm />
      </div>
    </div>
