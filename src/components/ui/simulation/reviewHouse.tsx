    ...
    <div className="flex flex-col items-center " >
      ...
      <Card
        ...
        tooltiptext={<p className='text-white'>La tasa de interés es el precio que se debe pagar por utilizar una cantidad de dinero durante un tiempo determinado.<br />
          <p className='flex text-white'><p className='font-bold text-white mr-1'>Tasa %MV: </p>  Tasa nóminal mes vencido</p>
          <p className='flex text-white'><p className='font-bold text-white mr-1'>Tasa EA:</p>Tasa efectiva anual</p>
        </p>
        }
      />
      {
