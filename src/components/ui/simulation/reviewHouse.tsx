...
export const ReviewHouse: React.FC<ReviewHouseProps> = ({disbursementValue,financedValue,fireInsurance,lifeInsurance,monthlyCoute,monthlyFee,numberPeriods,rate}) => (
