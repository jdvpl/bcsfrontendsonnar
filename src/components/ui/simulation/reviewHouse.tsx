      ...
      descriptionHtml={
        <div className="pl-[33px]">
          <div className="flex">
            ...
            <Typography variant='caption1' typeFont='Light' componentHTML='span' className="">Tasa nominal mes vencido</Typography>
          </div>
          <div className="flex">
            <Typography variant='caption1' typeFont='Bold' componentHTML='p' className="  mr-1">EA:</Typography>
            <Typography variant='caption1' typeFont='Light' componentHTML='span'>Tasa efectiva anual</Typography>
          </div>
        </div>
      }
      typeFontProps={typeFontsPropsNormal}
