...
export const Card: React.FC<CardProps> = ({
  ...
  <div className={`${className}`} id={id}>
    <div className="flex relative">
      ...
      <Typography variant={typeFontProps.variantTypographyTitle || 'bodyM3'} typeFont={typeFontProps.typeFontTypograhyTitle} componentHTML={typeFontProps.typeTagTypograhyTitle || 'p'} className={classtitle}>{title}</Typography>
      {tooltip ?
        <ToolTipInfo
          id="tax"
          info=""
    ...
    <div className={text}>
      {value &&
        <Typography variant={typeFontProps.variantDescriptionTypography || 'bodyM1'} typeFont={typeFontProps.typeFontDescriptionTypograhy} componentHTML={typeFontProps.typeDescriptionTagTypograhy || 'p'} className='pl-[10px]'>{value}</Typography>
      }
      {subvalue &&
        <Typography variant={typeFontProps.variantSubDescriptionTypography || 'bodyM1'} typeFont={typeFontProps.typeFontSubcDescriptionTypograhy} componentHTML={typeFontProps.typetSubcDescriptionTagTypograhy || 'p'} className={`text-[${textsub}px]  pl-[5px] mt-2`}>{subvalue}</Typography>
      }
    </div>
    {
      description ?
