...
describe('Render images', () => {
  it('render images', () => {
    ...
    const image1 = screen.getByTestId('delantera');
    const image2 = screen.getByTestId('trasera');
    const buttonFront = screen.getByTestId('changeFront');
    const buttonBack = screen.getByTestId('changeBack');

    expect(image1).toBeInTheDocument();
    expect(image2).toBeInTheDocument();
    expect(buttonBack).toBeInTheDocument();
    expect(buttonFront).toBeInTheDocument();
  });
  it('take photo again', () => {
