...
test('debe retornar el estilo correcto para el contenedor principal y el contenedor de icono', () => {
  ...
  const expectedOutput = {
    ...
    iconContainerStyle: 'h-[4.25rem] max-w-[4rem] max-h-[4.25rem] mim-w-[4rem] mr-1 justify-center w-full flex items-center rounded-[0.75rem] bg-white group-hover:bg-primario-20'
  };
